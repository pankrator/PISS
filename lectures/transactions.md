...
координаторът знае, с кои точно сървъри трябва да си говори, за да се случи
магията.
...
1. Координаторът чака потвърждение от всички.
1. Край.
...
```java
// Координаторът пита участник (т.е. сървър) дали гласува "ЗА" приемането на транзакцията.
...
// Координаторът пита участник дали е приключил транзакцията.
